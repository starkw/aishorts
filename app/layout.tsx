...
export const metadata: Metadata = {
  title: {
    default: "AI Shorts - 免费 AI 图像生成器 | 无需注册，无需信用卡",
    template: "%s | AI Shorts",
  },
  description:
    "打开就能用的免费 AI 出图工具。支持文生图与图生图，199 个现成模板，输出不加水印，图片只存在你的浏览器里。不需要 ChatGPT 账号，不需要信用卡。",
  keywords: [
    "免费AI绘画",
    "AI图像生成",
    "免费文生图",
  ...
  openGraph: {
    ...
    url: siteUrl,
    siteName: "AI Shorts",
    title: "AI Shorts - 免费 AI 图像生成器 | 无需注册，无需信用卡",
    description:
